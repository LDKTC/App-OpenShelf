...
/// out of `settings_screen.dart` directly so its `dart:io`-based
/// [UpdateService] (APK download + install) doesn't get pulled into the
/// web build, which has no APK-install equivalent.
